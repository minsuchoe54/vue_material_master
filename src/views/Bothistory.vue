         ...
         <div class="card-body px-2 pb-2">
           <div class="table-responsive p-0">
            ...
            <!-- <template #table-actions>
                <form @submit.prevent="onSubmit" v-on:submit="search">
                  <input type="text" name="name" id="name" v-model="this.search_keyword">
                </form>
            </template> -->
          </vue-good-table>
           </div>
    ...
    methods:{
      ...
      async getFromServer(params){
        try {
          ...
          let param = '/api/bot-histories?pagination[page]='+this.serverParams.page+'&pagination[pageSize]='+this.serverParams.perPage+'&[fields][0]=name&[fields][1]=storetype&[fields][2]=phone&[fields][3]=title&populate[info][fields][0]=name'+'&sort[0]='+this.serverParams.sort[0].field+'%3A'+this.serverParams.sort[0].type+keyword
